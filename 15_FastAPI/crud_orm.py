...
def get_items(db: Session, skip: int = 0, limit: int = 10): # 전체 아이템 데이터 조회 (Limit: 10~100)
...
def update_item(db: Session, item_id: int, item_update: ItemUpdate): # 하나의 데이터 업데이트 {item_id}
